 ...
 * ——basePath
 */
public class SDKLogTool {
    private static final String TAG = "SDKLogTool";
    ...
    public static SDKLogTool getInstance() {
        if (mInstance == null) {
            synchronized (SDKLogTool.class) {
                if (mInstance == null) {
                    mInstance = new SDKLogTool();
                }
            }
        }
        return mInstance;
...
//    public static void jsonSave(String TAG, String info) {
//
//        json(TAG, info);
...
//    }
    ...
    public static void LogSaveNoLog(String TAG, String info) {
        if (mInstance != null && mInstance.isSave) {
            info = getLogPosition() + " " + info;
            LogD(TAG, info);
            LogFileUtil.writeLog(TAG + " : " + info);
